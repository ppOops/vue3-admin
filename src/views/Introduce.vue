<template>
  <el-card class="account-container">
    ...
    <div v-for="(item, index) in list" :key="index"
       >
            <audio-play :src="item.src" :isPlay="item.isPlay" :id="index"
            @changeStatus="changeStatus"></audio-play>
    </div>
...
export default {
  ...
  setup() {
    const state = reactive({
      list: [{id:1, isPlay: false, src: 'https://wdd.js.org/element-audio/static/falling-star.mp3'}, {id:2, src: 'https://wdd.js.org/element-audio/static/falling-star.mp3'}, {id:3, src: 'https://wdd.js.org/element-audio/static/falling-star.mp3'}], // 数据列表
    })
    const goJuejin = () => {
